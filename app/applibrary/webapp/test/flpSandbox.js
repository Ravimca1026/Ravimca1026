		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Library",
									"targetURL": "#commindsetapplibraryapplibrary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetapplibraryapplibrary-display": {
								"semanticObject": "commindsetapplibraryapplibrary",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.applibrary.admin.AppTracker",
									"url": sap.ui.require.toUrl("com/mindset/applibrary/admin/AppTracker")
								}
							}
						}
					}
